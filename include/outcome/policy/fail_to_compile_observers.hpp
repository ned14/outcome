...
#define OUTCOME_FAIL_TO_COMPILE_OBSERVERS_MESSAGE                                                                                                                                                                                                                                                                              \
  ...
  "exception for a result/outcome given an EC or E type which is not void, and for whom "                                                                                                                                                                                                                                      \
  "trait::has_error_code_v<EC>, trait::has_exception_ptr_v<EC>, and trait::has_exception_ptr_v<E> "                                                                                                                                                                                                                            \
  "are all false. Please specify a NoValuePolicy to tell result/outcome what to do, or else use "                                                                                                                                                                                                                              \
