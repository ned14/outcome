...
#define BOOST_STL11_SYSTEM_ERROR_MAP_NAMESPACE_BEGIN  BOOST_BINDLIB_NAMESPACE_BEGIN(BOOST_MONAD_V1, (stl11, inline))
#define BOOST_STL11_SYSTEM_ERROR_MAP_NAMESPACE_END    BOOST_BINDLIB_NAMESPACE_END  (BOOST_MONAD_V1, (stl11, inline))
