...
#define BOOST_OUTCOME_CATCH_EXCEPTION_TO_RESULT                                                                                                                                                                                                                                                                                \
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(EINVAL, e.what());                                                                                                                                                                                                                                                                        \
  }                                                                                                                                                                                                                                                                                                                            \
  \
catch(const std::domain_error &e)                                                                                                                                                                                                                                                                                              \
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(EDOM, e.what());                                                                                                                                                                                                                                                                          \
  }                                                                                                                                                                                                                                                                                                                            \
  \
catch(const std::length_error &e)                                                                                                                                                                                                                                                                                              \
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(E2BIG, e.what());                                                                                                                                                                                                                                                                         \
  }                                                                                                                                                                                                                                                                                                                            \
  \
catch(const std::out_of_range &e)                                                                                                                                                                                                                                                                                              \
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(ERANGE, e.what());                                                                                                                                                                                                                                                                        \
  }                                                                                                                                                                                                                                                                                                                            \
  \
...
\
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(error_code_extended(e.code(), e.what()));                                                                                                                                                                                                                                                 \
  }                                                                                                                                                                                                                                                                                                                            \
  \
catch(const std::overflow_error &e)                                                                                                                                                                                                                                                                                            \
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(EOVERFLOW, e.what());                                                                                                                                                                                                                                                                     \
  }                                                                                                                                                                                                                                                                                                                            \
  \
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(EAGAIN, e.what());                                                                                                                                                                                                                                                                        \
  }                                                                                                                                                                                                                                                                                                                            \
  \
\
catch(const std::bad_alloc &e)                                                                                                                                                                                                                                                                                                 \
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(ENOMEM, e.what());                                                                                                                                                                                                                                                                        \
  }                                                                                                                                                                                                                                                                                                                            \
  \
  ...
  {                                                                                                                                                                                                                                                                                                                            \
    return make_errored_result<void>(EAGAIN, "unknown exception");                                                                                                                                                                                                                                                             \
  }
