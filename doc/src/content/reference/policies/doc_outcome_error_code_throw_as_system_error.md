...
slug = "doc_outcome_error_code_throw_as_system_error.md"
weight = 20
+++
...
<span class="pun">{</span>
    ...
    <span class="pun">{</span>
        ...
        <span class="kwd">struct</span> <a href="doc_outcome_error_code_throw_as_system_error.md#standardese-outcome_v2_xxx::policy::error_code_throw_as_system_error%3CT,EC,E%3E"><span class="typ dec var fun">error_code_throw_as_system_error</span></a><span class="pun">;</span>
    <span class="pun">}</span>
<span class="pun">}</span>
</code></pre>
...
<a id="standardese-outcome_v2_xxx::policy::error_code_throw_as_system_error<T,EC,E>"/>
...
<a id="standardese-outcome_v2_xxx::policy::error_code_throw_as_system_error<T,EC,E>::wide_value_check<Impl>(Impl&&)"/>
...
<a id="standardese-outcome_v2_xxx::policy::error_code_throw_as_system_error<T,EC,E>::wide_error_check<Impl>(Impl&&)"/>
...
<a id="standardese-outcome_v2_xxx::policy::error_code_throw_as_system_error<T,EC,E>::wide_exception_check<Impl>(Impl&&)"/>
