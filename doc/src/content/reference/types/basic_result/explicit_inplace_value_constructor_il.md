...
Explicit inplace value constructor. Calls {{% api "hook_result_in_place_construction(basic_result<T, E, NoValuePolicy> *, Args ...)" %}} with `this`, `in_place_type<value_type>`, 'std::initializer_list<U>' and `Args ...`.
