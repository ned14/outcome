...
#endif
#define QUICKCPPLIB_PREVIOUS_COMMIT_REF dc5c6fc72a1b710fc85c2ad923550c1a518a511f
#define QUICKCPPLIB_PREVIOUS_COMMIT_DATE "2017-06-12 23:18:17 +00:00"
#define QUICKCPPLIB_PREVIOUS_COMMIT_UNIQUE dc5c6fc7
...
#define BOOST_OUTCOME_PREVIOUS_COMMIT_REF b5a69414eea1d212f1488d4bb681918e7fb5d0f4
#define BOOST_OUTCOME_PREVIOUS_COMMIT_DATE "2017-06-14 14:28:37 +00:00"
#define BOOST_OUTCOME_PREVIOUS_COMMIT_UNIQUE b5a69414
...
#else
#include <stdio.h>
namespace boost { namespace outcome { inline namespace _1_0_b5a69414 {
namespace detail
{
...
namespace std
{
  ...
  template <> struct is_error_code_enum<boost ::outcome ::_1_0_b5a69414::bad_outcome_errc> : std::true_type
  {
  };

  template <> struct is_error_condition_enum<boost ::outcome ::_1_0_b5a69414::bad_outcome_errc> : std::true_type
  {
  };
}
...
namespace quickcpplib { namespace _dc5c6fc7 {
...
#define QUICKCPPLIB_RINGBUFFERLOG_LEVEL 5
#else
...
inline quickcpplib::_dc5c6fc7::ringbuffer_log::simple_ringbuffer_log<BOOST_OUTCOME_DEFAULT_EXTENDED_ERROR_CODE_LOG_SIZE> &extended_error_code_log()
{
  static quickcpplib::_dc5c6fc7::ringbuffer_log::simple_ringbuffer_log<BOOST_OUTCOME_DEFAULT_EXTENDED_ERROR_CODE_LOG_SIZE> log(quickcpplib::_dc5c6fc7::ringbuffer_log::level::error);
  return log;
}
...
class error_code_extended : public stl11::error_code
{
  ...
  using unique_id = quickcpplib::_dc5c6fc7::ringbuffer_log::simple_ringbuffer_log<4096>::unique_id;
  size_t _unique_id;
public:
  ...
  explicit error_code_extended(stl11::error_code &&e, const char *msg = nullptr, unsigned code1 = 0, unsigned code2 = 0, bool backtrace = false)
      ...
      , _unique_id(msg ? extended_error_code_log().emplace_back(quickcpplib::_dc5c6fc7::ringbuffer_log::level::error, msg, code1, code2, backtrace ? nullptr : "", 0) : (size_t) -1)
  {
    BOOST_OUTCOME_ERROR_CODE_EXTENDED_CREATION_HOOK;
  }
...
namespace detail
{
  ...
  {
    QUICKCPPLIB_CONSTEXPR do_change_state(P * , T && , S ) {}
    void dismiss() {}
  };
...
#pragma warning(pop)
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_trivial(const value_storage_impl_trivial &o) noexcept(is_nothrow_copy_constructible)
      : _empty(empty_type())
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_trivial(value_storage_impl_trivial &&o) noexcept(is_nothrow_move_constructible)
      : _empty(empty_type())
      , type(storage_type::empty)
  {
    switch(o.type)
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_trivial &operator=(const value_storage_impl_trivial &o) noexcept(is_nothrow_copy_assignable)
  {
    if(type == o.type)
    {
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_trivial &operator=(value_storage_impl_trivial &&o) noexcept(is_nothrow_move_assignable)
  {
    if(type == o.type)
    {
...
#pragma warning(pop)
  ...
  template <class... Args>
  QUICKCPPLIB_CONSTEXPR explicit value_storage_impl_trivial(emplace_t, Args &&... args) noexcept(std::is_nothrow_constructible<value_type, Args...>::value)
      : value(std::forward<Args>(args)...)
  {
    type = storage_type::value;
  }
...
#pragma warning(pop)
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_nontrivial(const value_storage_impl_nontrivial &o) noexcept(is_nothrow_copy_constructible)
      : _empty(empty_type())
      , type(storage_type::empty)
  {
    switch(o.type)
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_nontrivial(value_storage_impl_nontrivial &&o) noexcept(is_nothrow_move_constructible)
      : _empty(empty_type())
      , type(storage_type::empty)
  {
    switch(o.type)
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_nontrivial &operator=(const value_storage_impl_nontrivial &o) noexcept(is_nothrow_copy_assignable)
  {
    if(type == o.type)
    {
  ...
  QUICKCPPLIB_CONSTEXPR value_storage_impl_nontrivial &operator=(value_storage_impl_nontrivial &&o) noexcept(is_nothrow_move_assignable)
  {
    if(type == o.type)
    {
...
#pragma warning(pop)
  ...
  template <class... Args>
  QUICKCPPLIB_CONSTEXPR explicit value_storage_impl_nontrivial(emplace_t, Args &&... args) noexcept(std::is_nothrow_constructible<value_type, Args...>::value)
      : value(std::forward<Args>(args)...)
  {
    type = storage_type::value;
  }
...
namespace std
{
  ...
  template <class _value_type, class _error_type, class _exception_type> inline istream &operator>>(istream &s, boost ::outcome ::_1_0_b5a69414::value_storage<_value_type, _error_type, _exception_type> &v)
  {
    using namespace boost ::outcome ::_1_0_b5a69414;
    switch(v.type)
    {
  ...
  template <class _value_type> inline ostream &operator<<(ostream &s, const boost ::outcome ::_1_0_b5a69414::value_storage<_value_type, void, void> &v)
  {
    using namespace boost ::outcome ::_1_0_b5a69414;
  ...
  template <class _value_type, class _error_type> inline ostream &operator<<(ostream &s, const boost ::outcome ::_1_0_b5a69414::value_storage<_value_type, _error_type, void> &v)
  {
    using namespace boost ::outcome ::_1_0_b5a69414;
    using _exception_type = void;
    switch(v.type)
  ...
  template <class _value_type, class _error_type, class _exception_type> inline ostream &operator<<(ostream &s, const boost ::outcome ::_1_0_b5a69414::value_storage<_value_type, _error_type, _exception_type> &v)
  {
    using namespace boost ::outcome ::_1_0_b5a69414;
    switch(v.type)
    {
...
namespace std
{
  inline istream &operator>>(istream &s, quickcpplib::_dc5c6fc7::tribool::tribool &a)
  {
    char c;
    s >> c;
    a = (c == '1') ? quickcpplib::_dc5c6fc7::tribool::tribool::true_ : (c == '0') ? quickcpplib::_dc5c6fc7::tribool::tribool::false_ : quickcpplib::_dc5c6fc7::tribool::tribool::other;
    return s;
  }
  inline ostream &operator<<(ostream &s, quickcpplib::_dc5c6fc7::tribool::tribool a)
  {
    char c = (a == quickcpplib::_dc5c6fc7::tribool::tribool::true_) ? '1' : (a == quickcpplib::_dc5c6fc7::tribool::tribool::false_) ? '0' : '?';
    return s << c;
  }
}
...
QUICKCPPLIB_CONSTEXPR basic_monad &operator=(basic_monad &&) = default;

QUICKCPPLIB_CONSTEXPR basic_monad &operator=(const basic_monad &) = default;
...
#undef BOOST_OUTCOME_BASIC_MONAD_NAME
  ...
  constexpr explicit operator quickcpplib::_dc5c6fc7::tribool::tribool() const noexcept { return has_value() ? quickcpplib::_dc5c6fc7::tribool::tribool::true_ : empty() ? quickcpplib::_dc5c6fc7::tribool::tribool::unknown : quickcpplib::_dc5c6fc7::tribool::tribool::false_; }
...
namespace std
{
  ...
  template <class Impl> inline void swap(boost ::outcome ::_1_0_b5a69414::basic_monad<Impl> &a, boost ::outcome ::_1_0_b5a69414::basic_monad<Impl> &b) { a.swap(b); }
}
