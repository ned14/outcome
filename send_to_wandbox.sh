...
include/boost/monad/bindlib/scripts/GenSingleHeader.py -DBOOST_MONAD_DISABLE_VALGRIND=1 -Evalgrind include/boost/monad/future.hpp > include/boost/monad/single_include.hpp
