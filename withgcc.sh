...
g++-4.8 -std=c++0x -O1 -DNDEBUG -g -gdwarf-2 -o unittests_valgrind unittests.cpp -lrt -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-elide-constructors -DBOOST_SPINLOCK_ENABLE_VALGRIND
