  ...
  000000000000000E: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$option_policy@H@detail@v1_std_std@outcome@boost@@@v1_std_std@outcome@boost@@XZ
  0000000000000013: 80 7C 24 2C 00     cmp         byte ptr [rsp+2Ch],0
  0000000000000018: 74 15              je          000000000000002F
  000000000000001A: 6B 44 24 28 03     imul        eax,dword ptr [rsp+28h],3
  000000000000001F: 89 06              mov         dword ptr [rsi],eax
  0000000000000021: C6 46 04 01        mov         byte ptr [rsi+4],1
  0000000000000025: 48 89 F0           mov         rax,rsi
  0000000000000028: 48 83 C4 68        add         rsp,68h
  000000000000002C: 5F                 pop         rdi
  000000000000002D: 5E                 pop         rsi
  000000000000002E: C3                 ret
  000000000000002F: 48 8D 74 24 30     lea         rsi,[rsp+30h]
  0000000000000034: BA 02 00 00 00     mov         edx,2
  0000000000000039: 48 89 F1           mov         rcx,rsi
  000000000000003C: E8 00 00 00 00     call        replaced
  0000000000000000: 56                 push        rsi
  0000000000000001: 57                 push        rdi
  ...
  0000000000000041: 48 8D 7C 24 40     lea         rdi,[rsp+40h]
  0000000000000046: 48 89 F9           mov         rcx,rdi
  0000000000000049: 48 89 F2           mov         rdx,rsi
  ...
  0000000000000051: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@v1_std_std@outcome@boost@@]
                    00
  0000000000000058: 48 89 F9           mov         rcx,rdi
  000000000000005B: E8 00 00 00 00     call        _CxxThrowException
  0000000000000060: 0F 0B              ud2
  0000000000000062: 66 66 66 66 66 2E  nop         word ptr cs:[rax+rax]
                    0F 1F 84 00 00 00
                    00 00
