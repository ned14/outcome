  ...
  0000000000000006: 48 89 CE           mov         rsi,rcx
  0000000000000009: 48 8D 4C 24 28     lea         rcx,[rsp+28h]
  000000000000000E: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$option_policy@H@policy@_1_0_std_std_9274c0d4@outcome@boost@@@_1_0_std_std_9274c0d4@outcome@boost@@XZ
  0000000000000013: 48 8B 44 24 28     mov         rax,qword ptr [rsp+28h]
  0000000000000018: 48 B9 00 00 00 00  mov         rcx,0FF00000000h
  0000000000000022: 48 85 C8           test        rax,rcx
  0000000000000025: 74 13              je          000000000000003A
  0000000000000027: 8D 04 40           lea         eax,[rax+rax*2]
  000000000000002A: 89 06              mov         dword ptr [rsi],eax
  000000000000002C: C6 46 04 01        mov         byte ptr [rsi+4],1
  0000000000000030: 48 89 F0           mov         rax,rsi
  0000000000000033: 48 83 C4 68        add         rsp,68h
  0000000000000037: 5F                 pop         rdi
  0000000000000038: 5E                 pop         rsi
  0000000000000039: C3                 ret
  000000000000003A: 48 8D 74 24 30     lea         rsi,[rsp+30h]
  000000000000003F: BA 02 00 00 00     mov         edx,2
  0000000000000044: 48 89 F1           mov         rcx,rsi
  0000000000000000: 56                 push        rsi
  0000000000000001: 57                 push        rdi
  ...
  000000000000004C: 48 8D 7C 24 40     lea         rdi,[rsp+40h]
  0000000000000051: 48 89 F9           mov         rcx,rdi
  0000000000000054: 48 89 F2           mov         rdx,rsi
  ...
  000000000000005C: 48 8D 15 00 00 00  lea         rdx,[_TI5?AVmonad_error@_1_0_std_std_9274c0d4@outcome@boost@@]
  0000000000000063: 48 89 F9           mov         rcx,rdi
  0000000000000066: FF 15 00 00 00 00  call        qword ptr [__imp__CxxThrowException]
  000000000000006C: 0F 0B              ud2
  000000000000006E: 66 90              xchg        ax,ax
