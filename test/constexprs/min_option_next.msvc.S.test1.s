  ...
  0000000000000020: 88 44 24 40        mov         byte ptr [rsp+40h],al
  0000000000000024: 89 54 24 50        mov         dword ptr [rsp+50h],edx
  0000000000000028: C6 44 24 54 01     mov         byte ptr [rsp+54h],1
  000000000000002D: 4C 8D 44 24 40     lea         r8,[rsp+40h]
  ...
  000000000000000D: C7 44 24 20 00 00  mov         dword ptr [rsp+20h],0
                    00 00
  0000000000000015: 41 0F B6 50 04     movzx       edx,byte ptr [r8+4]
  000000000000001A: 44 8B CA           mov         r9d,edx
  000000000000001D: 41 83 E9 01        sub         r9d,1
  0000000000000021: 75 07              jne         000000000000002A
  0000000000000023: 41 8B 00           mov         eax,dword ptr [r8]
  0000000000000026: 89 44 24 48        mov         dword ptr [rsp+48h],eax
  000000000000002A: 88 54 24 4C        mov         byte ptr [rsp+4Ch],dl
  000000000000002E: 48 8D 54 24 48     lea         rdx,[rsp+48h]
  ...
  00000000000000EE: 74 0A              je          00000000000000FA
  00000000000000F0: 83 E9 01           sub         ecx,1
  00000000000000F3: 74 05              je          00000000000000FA
  00000000000000F5: 83 F9 01           cmp         ecx,1
  00000000000000F8: 75 04              jne         00000000000000FE
  00000000000000FA: C6 42 04 00        mov         byte ptr [rdx+4],0
  00000000000000FE: 41 8B C0           mov         eax,r8d
  0000000000000101: 48 81 C4 A0 00 00  add         rsp,0A0h
                    00
  0000000000000108: 5D                 pop         rbp
  0000000000000109: C3                 ret

  0000000000000038: 89 03              mov         dword ptr [rbx],eax
  000000000000003A: 48 8B C3           mov         rax,rbx
  000000000000003D: C6 43 04 01        mov         byte ptr [rbx+4],1
