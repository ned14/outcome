  ...
  0000000000000016: 48 89 44 24 20     mov         qword ptr [rsp+20h],rax
  000000000000001B: 80 7C 24 24 00     cmp         byte ptr [rsp+24h],0
  0000000000000020: 74 12              je          0000000000000034
  0000000000000022: 8D 0C 40           lea         ecx,[rax+rax*2]
  0000000000000025: C6 43 04 01        mov         byte ptr [rbx+4],1
  0000000000000029: 89 0B              mov         dword ptr [rbx],ecx
  000000000000002B: 48 8B C3           mov         rax,rbx
  000000000000002E: 48 83 C4 30        add         rsp,30h
  0000000000000032: 5B                 pop         rbx
  0000000000000033: C3                 ret
  0000000000000034: B9 02 00 00 00     mov         ecx,2
