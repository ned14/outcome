  ...
  000000000000001A: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$result_policy@H@detail@lightweight_futures@v1_std@spinlock@boost@@@lightweight_futures@v1_std@spinlock@boost@@XZ
  000000000000001F: 48 8B D0           mov         rdx,rax
  0000000000000022: 0F B6 40 10        movzx       eax,byte ptr [rax+10h]
  0000000000000026: 84 C0              test        al,al
  0000000000000028: 0F 95 C1           setne       cl
  000000000000002B: 84 C9              test        cl,cl
  000000000000002D: 0F 85 B7 00 00 00  jne         00000000000000EA
  0000000000000033: C7 45 A7 02 00 00  mov         dword ptr [rbp-59h],2
                    00
  ...
  000000000000003F: 48 89 45 AF        mov         qword ptr [rbp-51h],rax
  0000000000000043: 0F 28 45 A7        movaps      xmm0,xmmword ptr [rbp-59h]
  0000000000000047: 66 0F 7F 45 B7     movdqa      xmmword ptr [rbp-49h],xmm0
  000000000000004C: 48 8D 55 C7        lea         rdx,[rbp-39h]
  0000000000000050: 48 8D 4D B7        lea         rcx,[rbp-49h]
  ...
  0000000000000059: 48 83 78 18 10     cmp         qword ptr [rax+18h],10h
  000000000000005E: 72 03              jb          0000000000000063
  0000000000000060: 48 8B 00           mov         rax,qword ptr [rax]
  0000000000000063: 48 8D 0D 00 00 00  lea         rcx,[??_7exception@std@@6B@]
                    00
  000000000000006A: 48 89 4D E7        mov         qword ptr [rbp-19h],rcx
  000000000000006E: 33 C9              xor         ecx,ecx
  0000000000000070: 48 89 4D EF        mov         qword ptr [rbp-11h],rcx
  0000000000000074: 48 89 4D F7        mov         qword ptr [rbp-9],rcx
  0000000000000078: 48 89 45 A7        mov         qword ptr [rbp-59h],rax
  000000000000007C: C6 45 AF 01        mov         byte ptr [rbp-51h],1
  0000000000000080: 48 8D 55 EF        lea         rdx,[rbp-11h]
  0000000000000084: 48 8D 4D A7        lea         rcx,[rbp-59h]
  0000000000000088: E8 00 00 00 00     call        __std_exception_copy
  000000000000008D: 48 8D 05 00 00 00  lea         rax,[??_7logic_error@std@@6B@]
                    00
  0000000000000094: 48 89 45 E7        mov         qword ptr [rbp-19h],rax
  0000000000000098: 4C 8B 45 DF        mov         r8,qword ptr [rbp-21h]
  000000000000009C: 49 83 F8 10        cmp         r8,10h
  00000000000000A0: 72 10              jb          00000000000000B2
  00000000000000A2: 49 FF C0           inc         r8
  00000000000000A5: 48 8B 55 C7        mov         rdx,qword ptr [rbp-39h]
  00000000000000A9: 48 8D 4D C7        lea         rcx,[rbp-39h]
  00000000000000AD: E8 00 00 00 00     call        replaced
  ...
  00000000000000B2: 48 C7 45 DF 0F 00  mov         qword ptr [rbp-21h],0Fh
                    00 00
  00000000000000BA: 48 C7 45 D7 00 00  mov         qword ptr [rbp-29h],0
                    00 00
  00000000000000C2: C6 45 C7 00        mov         byte ptr [rbp-39h],0
  00000000000000C6: 48 8D 05 00 00 00  lea         rax,[??_7monad_error@lightweight_futures@v1_std@spinlock@boost@@6B@]
                    00
  00000000000000CD: 48 89 45 E7        mov         qword ptr [rbp-19h],rax
  00000000000000D1: 0F 28 45 B7        movaps      xmm0,xmmword ptr [rbp-49h]
  00000000000000D5: 0F 11 45 FF        movups      xmmword ptr [rbp-1],xmm0
  00000000000000D9: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@lightweight_futures@v1_std@spinlock@boost@@]
                    00
  00000000000000E0: 48 8D 4D E7        lea         rcx,[rbp-19h]
  00000000000000E4: E8 00 00 00 00     call        _CxxThrowException
  00000000000000E9: CC                 int         3
  00000000000000EA: 3C 02              cmp         al,2
  00000000000000EC: 0F 94 C0           sete        al
  00000000000000EF: 84 C0              test        al,al
  00000000000000F1: 74 25              je          0000000000000118
  00000000000000F3: 0F 10 02           movups      xmm0,xmmword ptr [rdx]
  00000000000000F6: 0F 29 45 B7        movaps      xmmword ptr [rbp-49h],xmm0
  00000000000000FA: 48 8D 55 B7        lea         rdx,[rbp-49h]
  00000000000000FE: 48 8D 4D 17        lea         rcx,[rbp+17h]
  0000000000000102: E8 00 00 00 00     call        replaced
...
$LN19:
  ...
  0000000000000107: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  000000000000010E: 48 8D 4D 17        lea         rcx,[rbp+17h]
  0000000000000112: E8 00 00 00 00     call        _CxxThrowException
  0000000000000117: 90                 nop
  0000000000000118: 8B 02              mov         eax,dword ptr [rdx]
  000000000000011A: 48 81 C4 D0 00 00  add         rsp,0D0h
                    00
  0000000000000121: 5D                 pop         rbp
  0000000000000122: C3                 ret
