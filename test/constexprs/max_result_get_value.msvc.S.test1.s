  ...
  0000000000000007: 48 81 EC D0 00 00  sub         rsp,0D0h
                    00
  000000000000000E: 48 C7 45 0F FE FF  mov         qword ptr [rbp+0Fh],0FFFFFFFFFFFFFFFEh
                    FF FF
  ...
  0000000000000020: 0F B6 50 10        movzx       edx,byte ptr [rax+10h]
  0000000000000024: 84 D2              test        dl,dl
  0000000000000026: 0F 95 C1           setne       cl
  0000000000000029: 84 C9              test        cl,cl
  000000000000002B: 0F 85 B7 00 00 00  jne         00000000000000E8
  0000000000000031: C7 45 A7 02 00 00  mov         dword ptr [rbp-59h],2
                    00
  ...
  000000000000003D: 48 89 45 AF        mov         qword ptr [rbp-51h],rax
  0000000000000041: 0F 28 45 A7        movaps      xmm0,xmmword ptr [rbp-59h]
  0000000000000045: 66 0F 7F 45 B7     movdqa      xmmword ptr [rbp-49h],xmm0
  000000000000004A: 48 8D 55 C7        lea         rdx,[rbp-39h]
  000000000000004E: 48 8D 4D B7        lea         rcx,[rbp-49h]
  ...
  0000000000000057: 48 83 78 18 10     cmp         qword ptr [rax+18h],10h
  000000000000005C: 72 03              jb          0000000000000061
  000000000000005E: 48 8B 00           mov         rax,qword ptr [rax]
  0000000000000061: 48 8D 0D 00 00 00  lea         rcx,[??_7exception@std@@6B@]
                    00
  0000000000000068: 48 89 4D E7        mov         qword ptr [rbp-19h],rcx
  000000000000006C: 33 C9              xor         ecx,ecx
  000000000000006E: 48 89 4D EF        mov         qword ptr [rbp-11h],rcx
  0000000000000072: 48 89 4D F7        mov         qword ptr [rbp-9],rcx
  0000000000000076: 48 89 45 A7        mov         qword ptr [rbp-59h],rax
  000000000000007A: C6 45 AF 01        mov         byte ptr [rbp-51h],1
  000000000000007E: 48 8D 55 EF        lea         rdx,[rbp-11h]
  0000000000000082: 48 8D 4D A7        lea         rcx,[rbp-59h]
  0000000000000086: E8 00 00 00 00     call        __std_exception_copy
  000000000000008B: 48 8D 05 00 00 00  lea         rax,[??_7logic_error@std@@6B@]
                    00
  0000000000000092: 48 89 45 E7        mov         qword ptr [rbp-19h],rax
  0000000000000096: 4C 8B 45 DF        mov         r8,qword ptr [rbp-21h]
  000000000000009A: 49 83 F8 10        cmp         r8,10h
  000000000000009E: 72 10              jb          00000000000000B0
  00000000000000A0: 49 FF C0           inc         r8
  00000000000000A3: 48 8B 55 C7        mov         rdx,qword ptr [rbp-39h]
  00000000000000A7: 48 8D 4D C7        lea         rcx,[rbp-39h]
  00000000000000AB: E8 00 00 00 00     call        replaced
  ...
  00000000000000B0: 48 C7 45 DF 0F 00  mov         qword ptr [rbp-21h],0Fh
                    00 00
  00000000000000B8: 48 C7 45 D7 00 00  mov         qword ptr [rbp-29h],0
                    00 00
  00000000000000C0: C6 45 C7 00        mov         byte ptr [rbp-39h],0
  00000000000000C4: 48 8D 05 00 00 00  lea         rax,[??_7monad_error@v1_std_std@outcome@boost@@6B@]
                    00
  00000000000000CB: 48 89 45 E7        mov         qword ptr [rbp-19h],rax
  00000000000000CF: 0F 28 45 B7        movaps      xmm0,xmmword ptr [rbp-49h]
  00000000000000D3: 0F 11 45 FF        movups      xmmword ptr [rbp-1],xmm0
  00000000000000D7: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@v1_std_std@outcome@boost@@]
                    00
  00000000000000DE: 48 8D 4D E7        lea         rcx,[rbp-19h]
  00000000000000E2: E8 00 00 00 00     call        _CxxThrowException
  00000000000000E7: CC                 int         3
  00000000000000E8: 80 FA 02           cmp         dl,2
  00000000000000EB: 0F 94 C1           sete        cl
  00000000000000EE: 84 C9              test        cl,cl
  00000000000000F0: 75 0C              jne         00000000000000FE
  00000000000000F2: 80 EA 02           sub         dl,2
  00000000000000F5: 80 FA 01           cmp         dl,1
  00000000000000F8: 77 29              ja          0000000000000123
  00000000000000FA: 84 C9              test        cl,cl
  00000000000000FC: 74 25              je          0000000000000123
  00000000000000FE: 0F 10 00           movups      xmm0,xmmword ptr [rax]
  0000000000000101: 0F 29 45 B7        movaps      xmmword ptr [rbp-49h],xmm0
  0000000000000105: 48 8D 55 B7        lea         rdx,[rbp-49h]
  0000000000000109: 48 8D 4D 17        lea         rcx,[rbp+17h]
  000000000000010D: E8 00 00 00 00     call        replaced
...
$LN19:
  ...
  0000000000000112: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  0000000000000119: 48 8D 4D 17        lea         rcx,[rbp+17h]
  000000000000011D: E8 00 00 00 00     call        _CxxThrowException
  0000000000000122: 90                 nop
  0000000000000123: 8B 00              mov         eax,dword ptr [rax]
  0000000000000125: 48 81 C4 D0 00 00  add         rsp,0D0h
                    00
  000000000000012C: 5D                 pop         rbp
  000000000000012D: C3                 ret
