   ...
   d:	c6 44 24 20 01       	movb   $0x1,0x20(%rsp)
  12:	89 74 24 28          	mov    %esi,0x28(%rsp)
  16:	c6 44 24 40 01       	movb   $0x1,0x40(%rsp)
  1b:	48 8d 7c 24 28       	lea    0x28(%rsp),%rdi
  20:	e8 00 00 00 00       	callq  25 <_Z5test1i+0x25>
  25:	6b 6c 24 28 03       	imul   $0x3,0x28(%rsp),%ebp
  2a:	0f b6 44 24 40       	movzbl 0x40(%rsp),%eax
  ...
  40:	48 8d 7c 24 28       	lea    0x28(%rsp),%rdi
  45:	e8 00 00 00 00       	callq  4a <_Z5test1i+0x4a>
  4a:	c6 44 24 40 00       	movb   $0x0,0x40(%rsp)
  4f:	89 2b                	mov    %ebp,(%rbx)
  51:	c6 43 18 01          	movb   $0x1,0x18(%rbx)
  ...
  7d:	48 83 c4 48          	add    $0x48,%rsp
  81:	5b                   	pop    %rbx
  82:	5d                   	pop    %rbp
  83:	c3                   	retq   
  84:	48 89 c3             	mov    %rax,%rbx
  87:	0f b6 44 24 40       	movzbl 0x40(%rsp),%eax
  ...
  9d:	48 8d 7c 24 28       	lea    0x28(%rsp),%rdi
  a2:	e8 00 00 00 00       	callq  a7 <_Z5test1i+0xa7>
  a7:	c6 44 24 40 00       	movb   $0x0,0x40(%rsp)
  ac:	0f b6 44 24 20       	movzbl 0x20(%rsp),%eax
  ...
  cc:	c6 44 24 20 00       	movb   $0x0,0x20(%rsp)
