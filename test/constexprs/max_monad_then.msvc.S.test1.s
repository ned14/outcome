  ...
  0000000000000029: E8 00 00 00 00     call        ?unknown@@YA?AV?$monad@HVerror_code@std@@Vexception_ptr@2@Uthrow_monad_error@detail@lightweight_futures@v1_std@spinlock@boost@@@lightweight_futures@v1_std@spinlock@boost@@XZ
  ...
  0000000000000029: 48 8D 4C 24 48     lea         rcx,[rsp+48h]
  ...
  000000000000000A: 48 C7 44 24 20 FE  mov         qword ptr [rsp+20h],0FFFFFFFFFFFFFFFEh
                    FF FF FF
  0000000000000013: 48 89 9C 24 80 00  mov         qword ptr [rsp+80h],rbx
                    00 00
  000000000000001B: 48 8B DA           mov         rbx,rdx
  000000000000001E: 0F B6 4A 10        movzx       ecx,byte ptr [rdx+10h]
  0000000000000022: 84 C9              test        cl,cl
  0000000000000024: 0F 95 C0           setne       al
  0000000000000027: 84 C0              test        al,al
  0000000000000029: 75 06              jne         0000000000000031
  ...
  0000000000000031: 80 F9 02           cmp         cl,2
  0000000000000034: 0F 94 C2           sete        dl
  0000000000000037: 84 D2              test        dl,dl
  0000000000000039: 75 0B              jne         0000000000000046
  000000000000003B: 8D 41 FE           lea         eax,[rcx-2]
  000000000000003E: 3C 01              cmp         al,1
  0000000000000040: 77 64              ja          00000000000000A6
  0000000000000042: 84 D2              test        dl,dl
  0000000000000044: 74 29              je          000000000000006F
  0000000000000046: 0F 10 03           movups      xmm0,xmmword ptr [rbx]
  0000000000000049: 0F 29 44 24 30     movaps      xmmword ptr [rsp+30h],xmm0
  000000000000004E: 48 8D 54 24 30     lea         rdx,[rsp+30h]
  0000000000000053: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
...
$LN19:
  ...
  000000000000005D: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  0000000000000064: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  0000000000000069: E8 00 00 00 00     call        _CxxThrowException
  000000000000006E: CC                 int         3
  000000000000006F: 80 E9 02           sub         cl,2
  0000000000000072: 80 F9 01           cmp         cl,1
  0000000000000075: 77 2F              ja          00000000000000A6
  0000000000000077: 48 8B D3           mov         rdx,rbx
  000000000000007A: 48 8D 4C 24 30     lea         rcx,[rsp+30h]
  000000000000007F: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  0000000000000084: 48 8D 44 24 30     lea         rax,[rsp+30h]
  0000000000000089: 48 89 84 24 90 00  mov         qword ptr [rsp+90h],rax
                    00 00
  0000000000000091: 48 8D 4C 24 30     lea         rcx,[rsp+30h]
  0000000000000096: E8 00 00 00 00     call        ?__ExceptionPtrRethrow@@YAXPEBX@Z
  000000000000009B: 90                 nop
  000000000000009C: 48 8D 4C 24 30     lea         rcx,[rsp+30h]
  00000000000000A1: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  00000000000000A6: 8B 03              mov         eax,dword ptr [rbx]
  00000000000000A8: 8D 3C 40           lea         edi,[rax+rax*2]
  00000000000000AB: 0F B6 4B 10        movzx       ecx,byte ptr [rbx+10h]
  00000000000000AF: 83 E9 01           sub         ecx,1
  00000000000000B2: 74 20              je          00000000000000D4
  00000000000000B4: 83 E9 01           sub         ecx,1
  00000000000000B7: 74 1B              je          00000000000000D4
  00000000000000B9: 83 E9 01           sub         ecx,1
  00000000000000BC: 74 0E              je          00000000000000CC
  00000000000000BE: 83 F9 01           cmp         ecx,1
  00000000000000C1: 75 15              jne         00000000000000D8
  00000000000000C3: 48 C7 03 00 00 00  mov         qword ptr [rbx],0
                    00
  00000000000000CA: EB 08              jmp         00000000000000D4
  00000000000000CC: 48 8B CB           mov         rcx,rbx
  00000000000000CF: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  00000000000000D4: C6 43 10 00        mov         byte ptr [rbx+10h],0
  00000000000000D8: 8B C7              mov         eax,edi
  00000000000000DA: 48 8B 9C 24 80 00  mov         rbx,qword ptr [rsp+80h]
                    00 00
  00000000000000E2: 48 83 C4 70        add         rsp,70h
  00000000000000E6: 5F                 pop         rdi
  00000000000000E7: C3                 ret

  000000000000003E: 89 44 24 30        mov         dword ptr [rsp+30h],eax
  0000000000000042: C6 44 24 40 01     mov         byte ptr [rsp+40h],1
  0000000000000047: 48 8D 54 24 30     lea         rdx,[rsp+30h]
  ...
  0000000000000054: C7 44 24 20 04 00  mov         dword ptr [rsp+20h],4
                    00 00
  000000000000005C: 0F B6 4C 24 40     movzx       ecx,byte ptr [rsp+40h]
  0000000000000061: 83 E9 01           sub         ecx,1
  0000000000000064: 74 15              je          000000000000007B
  0000000000000066: 83 E9 01           sub         ecx,1
  0000000000000069: 74 10              je          000000000000007B
  000000000000006B: 83 F9 01           cmp         ecx,1
  000000000000006E: 75 0B              jne         000000000000007B
  0000000000000070: 48 8D 4C 24 30     lea         rcx,[rsp+30h]
  0000000000000075: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  000000000000007A: 90                 nop
  000000000000007B: 48 8B C7           mov         rax,rdi
  000000000000007E: 48 8B 5C 24 70     mov         rbx,qword ptr [rsp+70h]
