  ...
  0000000000000009: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  000000000000000E: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$result_policy@H@detail@v1_std_std@outcome@boost@@@v1_std_std@outcome@boost@@XZ
  0000000000000013: 0F B6 48 18        movzx       ecx,byte ptr [rax+18h]
  0000000000000017: 44 8B C1           mov         r8d,ecx
  000000000000001A: 41 83 E8 01        sub         r8d,1
  000000000000001E: 74 1B              je          000000000000003B
  0000000000000020: 41 83 F8 01        cmp         r8d,1
  0000000000000024: 75 1B              jne         0000000000000041
  0000000000000026: 0F 10 00           movups      xmm0,xmmword ptr [rax]
  0000000000000029: F2 0F 10 48 10     movsd       xmm1,mmword ptr [rax+10h]
  000000000000002E: 0F 11 44 24 20     movups      xmmword ptr [rsp+20h],xmm0
  0000000000000033: F2 0F 11 4C 24 30  movsd       mmword ptr [rsp+30h],xmm1
  0000000000000039: EB 06              jmp         0000000000000041
  000000000000003B: 8B 00              mov         eax,dword ptr [rax]
  000000000000003D: 89 44 24 20        mov         dword ptr [rsp+20h],eax
  0000000000000041: 88 4C 24 38        mov         byte ptr [rsp+38h],cl
  0000000000000045: 48 8D 54 24 20     lea         rdx,[rsp+20h]
  000000000000004A: 48 8D 4C 24 70     lea         rcx,[rsp+70h]
  ...
  0000000000000007: 48 81 EC B0 00 00  sub         rsp,0B0h
                    00
  000000000000000E: 0F B6 42 18        movzx       eax,byte ptr [rdx+18h]
  0000000000000012: 84 C0              test        al,al
  0000000000000014: 0F 85 9D 00 00 00  jne         00000000000000B7
  000000000000001A: C7 45 C7 02 00 00  mov         dword ptr [rbp-39h],2
                    00
  ...
  0000000000000026: 48 89 45 CF        mov         qword ptr [rbp-31h],rax
  000000000000002A: 48 8D 55 E7        lea         rdx,[rbp-19h]
  000000000000002E: 0F 28 45 C7        movaps      xmm0,xmmword ptr [rbp-39h]
  0000000000000032: 48 8D 4D D7        lea         rcx,[rbp-29h]
  0000000000000036: 66 0F 7F 45 D7     movdqa      xmmword ptr [rbp-29h],xmm0
  000000000000003B: E8 00 00 00 00     call        replaced
  0000000000000000: 40 53              push        rbx
  ...
  0000000000000040: 48 83 78 18 10     cmp         qword ptr [rax+18h],10h
  0000000000000045: 72 03              jb          000000000000004A
  0000000000000047: 48 8B 00           mov         rax,qword ptr [rax]
  000000000000004A: 48 8D 0D 00 00 00  lea         rcx,[??_7exception@std@@6B@]
                    00
  0000000000000051: 48 89 45 C7        mov         qword ptr [rbp-39h],rax
  0000000000000055: 48 89 4D 07        mov         qword ptr [rbp+7],rcx
  0000000000000059: 48 8D 55 0F        lea         rdx,[rbp+0Fh]
  000000000000005D: 33 C9              xor         ecx,ecx
  000000000000005F: C6 45 CF 01        mov         byte ptr [rbp-31h],1
  0000000000000063: 48 89 4D 0F        mov         qword ptr [rbp+0Fh],rcx
  0000000000000067: 48 89 4D 17        mov         qword ptr [rbp+17h],rcx
  000000000000006B: 48 8D 4D C7        lea         rcx,[rbp-39h]
  000000000000006F: E8 00 00 00 00     call        __std_exception_copy
  0000000000000074: 48 8D 05 00 00 00  lea         rax,[??_7logic_error@std@@6B@]
                    00
  000000000000007B: 48 89 45 07        mov         qword ptr [rbp+7],rax
  000000000000007F: 48 8B 45 FF        mov         rax,qword ptr [rbp-1]
  0000000000000083: 48 83 F8 10        cmp         rax,10h
  0000000000000087: 72 60              jb          00000000000000E9
  0000000000000089: 48 8B 4D E7        mov         rcx,qword ptr [rbp-19h]
  000000000000008D: 48 FF C0           inc         rax
  0000000000000090: 48 3D 00 10 00 00  cmp         rax,1000h
  0000000000000096: 72 4C              jb          00000000000000E4
  0000000000000098: F6 C1 1F           test        cl,1Fh
  000000000000009B: 75 2C              jne         00000000000000C9
  000000000000009D: 48 8B 41 F8        mov         rax,qword ptr [rcx-8]
  00000000000000A1: 48 3B C1           cmp         rax,rcx
  00000000000000A4: 73 29              jae         00000000000000CF
  00000000000000A6: 48 2B C8           sub         rcx,rax
  00000000000000A9: 48 83 F9 08        cmp         rcx,8
  00000000000000AD: 72 26              jb          00000000000000D5
  00000000000000AF: 48 83 F9 27        cmp         rcx,27h
  00000000000000B3: 77 26              ja          00000000000000DB
  00000000000000B5: EB 2A              jmp         00000000000000E1
  00000000000000B7: 3C 02              cmp         al,2
  00000000000000B9: 74 66              je          0000000000000121
  00000000000000BB: 8B 02              mov         eax,dword ptr [rdx]
  00000000000000BD: 8D 04 40           lea         eax,[rax+rax*2]
  00000000000000C0: 48 81 C4 B0 00 00  add         rsp,0B0h
                    00
  ...
  00000000000000E9: 0F 28 45 D7        movaps      xmm0,xmmword ptr [rbp-29h]
  ...
  00000000000000F4: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@v1_std_std@outcome@boost@@]
                    00
  00000000000000FB: 48 89 45 07        mov         qword ptr [rbp+7],rax
  00000000000000FF: 48 8D 4D 07        lea         rcx,[rbp+7]
  0000000000000103: 48 C7 45 FF 0F 00  mov         qword ptr [rbp-1],0Fh
                    00 00
  000000000000010B: 0F 11 45 1F        movups      xmmword ptr [rbp+1Fh],xmm0
  000000000000010F: 48 C7 45 F7 00 00  mov         qword ptr [rbp-9],0
                    00 00
  0000000000000117: C6 45 E7 00        mov         byte ptr [rbp-19h],0
  000000000000011B: E8 00 00 00 00     call        _CxxThrowException
  0000000000000120: CC                 int         3
  0000000000000121: 0F 10 02           movups      xmm0,xmmword ptr [rdx]
  0000000000000124: 48 8D 55 D7        lea         rdx,[rbp-29h]
  0000000000000128: 48 8D 4D 2F        lea         rcx,[rbp+2Fh]
  000000000000012C: 0F 29 45 D7        movaps      xmmword ptr [rbp-29h],xmm0
...
$LN19:
  ...
  0000000000000135: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  000000000000013C: 48 8D 4D 2F        lea         rcx,[rbp+2Fh]
  0000000000000140: E8 00 00 00 00     call        _CxxThrowException
  0000000000000145: CC                 int         3

  0000000000000054: 89 03              mov         dword ptr [rbx],eax
  0000000000000056: 48 8B C3           mov         rax,rbx
  0000000000000059: C6 43 18 01        mov         byte ptr [rbx+18h],1
