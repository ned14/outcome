  ...
  0000000000000009: C7 44 24 20 00 00  mov         dword ptr [rsp+20h],0
                    00 00
  0000000000000011: 41 0F B6 50 18     movzx       edx,byte ptr [r8+18h]
  0000000000000016: 44 8B CA           mov         r9d,edx
  0000000000000019: 41 83 E9 01        sub         r9d,1
  000000000000001D: 74 1D              je          000000000000003C
  000000000000001F: 41 83 F9 01        cmp         r9d,1
  0000000000000023: 75 1E              jne         0000000000000043
  0000000000000025: 41 0F 10 00        movups      xmm0,xmmword ptr [r8]
  0000000000000029: F2 41 0F 10 48 10  movsd       xmm1,mmword ptr [r8+10h]
  000000000000002F: 0F 11 44 24 28     movups      xmmword ptr [rsp+28h],xmm0
  0000000000000034: F2 0F 11 4C 24 38  movsd       mmword ptr [rsp+38h],xmm1
  000000000000003A: EB 07              jmp         0000000000000043
  000000000000003C: 41 8B 00           mov         eax,dword ptr [r8]
  000000000000003F: 89 44 24 28        mov         dword ptr [rsp+28h],eax
  0000000000000043: 88 54 24 40        mov         byte ptr [rsp+40h],dl
  0000000000000047: 48 8D 54 24 28     lea         rdx,[rsp+28h]
  ...
  0000000000000012: 48 C7 45 1F FE FF  mov         qword ptr [rbp+1Fh],0FFFFFFFFFFFFFFFEh
                    FF FF
  000000000000001A: 0F B6 4A 18        movzx       ecx,byte ptr [rdx+18h]
  000000000000001E: 84 C9              test        cl,cl
  0000000000000020: 0F 85 F3 00 00 00  jne         0000000000000119
  0000000000000026: C7 45 B7 02 00 00  mov         dword ptr [rbp-49h],2
                    00
  ...
  0000000000000032: 48 89 45 BF        mov         qword ptr [rbp-41h],rax
  0000000000000036: 0F 28 45 B7        movaps      xmm0,xmmword ptr [rbp-49h]
  000000000000003A: 66 0F 7F 45 C7     movdqa      xmmword ptr [rbp-39h],xmm0
  000000000000003F: 48 8D 55 D7        lea         rdx,[rbp-29h]
  0000000000000043: 48 8D 4D C7        lea         rcx,[rbp-39h]
  ...
  0000000000000056: 48 8D 0D 00 00 00  lea         rcx,[??_7exception@std@@6B@]
                    00
  000000000000005D: 48 89 4D F7        mov         qword ptr [rbp-9],rcx
  0000000000000061: 33 C9              xor         ecx,ecx
  0000000000000063: 48 89 4D FF        mov         qword ptr [rbp-1],rcx
  0000000000000067: 48 89 4D 07        mov         qword ptr [rbp+7],rcx
  000000000000006B: 48 89 45 B7        mov         qword ptr [rbp-49h],rax
  000000000000006F: C6 45 BF 01        mov         byte ptr [rbp-41h],1
  0000000000000073: 48 8D 55 FF        lea         rdx,[rbp-1]
  0000000000000077: 48 8D 4D B7        lea         rcx,[rbp-49h]
  000000000000007B: E8 00 00 00 00     call        __std_exception_copy
  0000000000000080: 48 8D 05 00 00 00  lea         rax,[??_7logic_error@std@@6B@]
                    00
  0000000000000087: 48 89 45 F7        mov         qword ptr [rbp-9],rax
  000000000000008B: 48 8B 45 EF        mov         rax,qword ptr [rbp-11h]
  000000000000008F: 48 83 F8 10        cmp         rax,10h
  0000000000000093: 72 4C              jb          00000000000000E1
  0000000000000095: 48 FF C0           inc         rax
  0000000000000098: 48 8B 4D D7        mov         rcx,qword ptr [rbp-29h]
  ...
  00000000000000E1: 48 C7 45 EF 0F 00  mov         qword ptr [rbp-11h],0Fh
                    00 00
  00000000000000E9: 48 C7 45 E7 00 00  mov         qword ptr [rbp-19h],0
                    00 00
  00000000000000F1: C6 45 D7 00        mov         byte ptr [rbp-29h],0
  00000000000000F5: 48 8D 05 00 00 00  lea         rax,[??_7monad_error@v1_std_std@outcome@boost@@6B@]
                    00
  00000000000000FC: 48 89 45 F7        mov         qword ptr [rbp-9],rax
  0000000000000100: 0F 28 45 C7        movaps      xmm0,xmmword ptr [rbp-39h]
  0000000000000104: 0F 11 45 0F        movups      xmmword ptr [rbp+0Fh],xmm0
  0000000000000108: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@v1_std_std@outcome@boost@@]
                    00
  000000000000010F: 48 8D 4D F7        lea         rcx,[rbp-9]
  0000000000000113: E8 00 00 00 00     call        _CxxThrowException
  0000000000000118: CC                 int         3
  0000000000000119: 80 F9 02           cmp         cl,2
  000000000000011C: 75 25              jne         0000000000000143
  000000000000011E: 0F 10 02           movups      xmm0,xmmword ptr [rdx]
  0000000000000121: 0F 29 45 C7        movaps      xmmword ptr [rbp-39h],xmm0
  0000000000000125: 48 8D 55 C7        lea         rdx,[rbp-39h]
  0000000000000129: 48 8D 4D 27        lea         rcx,[rbp+27h]
  000000000000012D: E8 00 00 00 00     call        replaced
...
$LN19:
  ...
  0000000000000132: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  0000000000000139: 48 8D 4D 27        lea         rcx,[rbp+27h]
  000000000000013D: E8 00 00 00 00     call        _CxxThrowException
  0000000000000142: CC                 int         3
  0000000000000143: 8B 02              mov         eax,dword ptr [rdx]
  0000000000000145: 44 8D 04 40        lea         r8d,[rax+rax*2]
  0000000000000149: 0F B6 C9           movzx       ecx,cl
  000000000000014C: 83 E9 01           sub         ecx,1
  000000000000014F: 74 0A              je          000000000000015B
  0000000000000151: 83 E9 01           sub         ecx,1
  0000000000000154: 74 05              je          000000000000015B
  0000000000000156: 83 F9 01           cmp         ecx,1
  0000000000000159: 75 04              jne         000000000000015F
  000000000000015B: C6 42 18 00        mov         byte ptr [rdx+18h],0
  000000000000015F: 41 8B C0           mov         eax,r8d
  0000000000000162: 48 81 C4 C0 00 00  add         rsp,0C0h
                    00
  0000000000000169: 5D                 pop         rbp
  000000000000016A: C3                 ret

  0000000000000051: 89 03              mov         dword ptr [rbx],eax
  0000000000000053: 48 8B C3           mov         rax,rbx
  0000000000000056: C6 43 18 01        mov         byte ptr [rbx+18h],1
  000000000000005A: 48 83 C4 50        add         rsp,50h
  000000000000005E: 5B                 pop         rbx
