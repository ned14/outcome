  ...
  000000000000000C: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  ...
  0000000000000016: 0F 10 40 10        movups      xmm0,xmmword ptr [rax+10h]
  000000000000001A: 0F 10 10           movups      xmm2,xmmword ptr [rax]
  000000000000001D: 66 0F 73 D8 08     psrldq      xmm0,8
  0000000000000022: 66 48 0F 7E C0     movq        rax,xmm0
  0000000000000027: 0F 11 54 24 20     movups      xmmword ptr [rsp+20h],xmm2
  000000000000002C: 84 C0              test        al,al
  000000000000002E: 74 1D              je          000000000000004D
  0000000000000030: 3C 02              cmp         al,2
  0000000000000032: 74 24              je          0000000000000058
  0000000000000034: 8B 44 24 20        mov         eax,dword ptr [rsp+20h]
  0000000000000038: C6 43 18 01        mov         byte ptr [rbx+18h],1
  000000000000003C: 8D 0C 40           lea         ecx,[rax+rax*2]
  000000000000003F: 48 8B C3           mov         rax,rbx
  0000000000000042: 89 0B              mov         dword ptr [rbx],ecx
  0000000000000044: 48 81 C4 90 00 00  add         rsp,90h
  000000000000004B: 5B                 pop         rbx
  000000000000004C: C3                 ret
  000000000000004D: B9 02 00 00 00     mov         ecx,2
  ...
  0000000000000058: 48 8D 54 24 20     lea         rdx,[rsp+20h]
  000000000000005D: 48 8D 4C 24 60     lea         rcx,[rsp+60h]
  0000000000000062: 0F 11 54 24 20     movups      xmmword ptr [rsp+20h],xmm2
  0000000000000000: 40 57              push        rdi
  0000000000000002: 48 83 EC 60        sub         rsp,60h
  0000000000000006: 48 C7 44 24 20 FE  mov         qword ptr [rsp+20h],0FFFFFFFFFFFFFFFEh
  000000000000000F: 48 89 5C 24 70     mov         qword ptr [rsp+70h],rbx
  ...
  00000000000000CF: 5F                 pop         rdi
  00000000000000D0: C3                 ret
  000000000000006C: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
  0000000000000073: 48 8D 4C 24 60     lea         rcx,[rsp+60h]
  0000000000000078: E8 00 00 00 00     call        _CxxThrowException
