  ...
  0000000000000002: 48 81 EC 90 00 00  sub         rsp,90h
  ...
  0000000000000017: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$monad_policy@H@policy@_1_0_std_std_9274c0d4@outcome@boost@@@_1_0_std_std_9274c0d4@outcome@boost@@XZ
  000000000000001C: 48 8B D0           mov         rdx,rax
  000000000000001F: 0F B6 48 18        movzx       ecx,byte ptr [rax+18h]
  0000000000000023: 84 C9              test        cl,cl
  0000000000000025: 75 0B              jne         0000000000000032
  0000000000000027: B9 02 00 00 00     mov         ecx,2
  ...
  0000000000000032: 8D 41 FE           lea         eax,[rcx-2]
  0000000000000035: 3C 01              cmp         al,1
  0000000000000037: 77 46              ja          000000000000007F
  0000000000000039: 80 F9 02           cmp         cl,2
  000000000000003C: 75 29              jne         0000000000000067
  000000000000003E: 0F 10 02           movups      xmm0,xmmword ptr [rdx]
  0000000000000041: 0F 29 44 24 30     movaps      xmmword ptr [rsp+30h],xmm0
  0000000000000046: 48 8D 54 24 30     lea         rdx,[rsp+30h]
  000000000000004B: 48 8D 4C 24 60     lea         rcx,[rsp+60h]
  0000000000000000: 40 57              push        rdi
  0000000000000002: 48 83 EC 60        sub         rsp,60h
  0000000000000006: 48 C7 44 24 20 FE  mov         qword ptr [rsp+20h],0FFFFFFFFFFFFFFFEh
  000000000000000F: 48 89 5C 24 70     mov         qword ptr [rsp+70h],rbx
  ...
  00000000000000CF: 5F                 pop         rdi
  00000000000000D0: C3                 ret
  0000000000000055: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
  000000000000005C: 48 8D 4C 24 60     lea         rcx,[rsp+60h]
  0000000000000061: E8 00 00 00 00     call        _CxxThrowException
  0000000000000066: CC                 int         3
  0000000000000067: 80 F9 03           cmp         cl,3
  000000000000006A: 75 13              jne         000000000000007F
  000000000000006C: 48 8D 4C 24 30     lea         rcx,[rsp+30h]
  0000000000000000: 40 53              push        rbx
  0000000000000002: 48 83 EC 20        sub         rsp,20h
  ...
  000000000000007E: CC                 int         3
  000000000000007F: 8B 1A              mov         ebx,dword ptr [rdx]
  0000000000000081: 0F B6 4C 24 58     movzx       ecx,byte ptr [rsp+58h]
  0000000000000086: 83 E9 01           sub         ecx,1
  0000000000000089: 74 14              je          000000000000009F
  000000000000008B: 83 E9 01           sub         ecx,1
  000000000000008E: 74 0F              je          000000000000009F
  0000000000000090: 83 F9 01           cmp         ecx,1
  0000000000000093: 75 0A              jne         000000000000009F
  0000000000000095: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  000000000000009A: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  000000000000009F: 8B C3              mov         eax,ebx
  00000000000000A1: 48 81 C4 90 00 00  add         rsp,90h
