  ...
  0000000000000007: 48 81 EC E0 00 00  sub         rsp,0E0h
                    00
  000000000000000E: 48 C7 45 FF FE FF  mov         qword ptr [rbp-1],0FFFFFFFFFFFFFFFEh
                    FF FF
  0000000000000016: 48 89 9C 24 F8 00  mov         qword ptr [rsp+0F8h],rbx
                    00 00
  000000000000001E: 48 8D 4D 07        lea         rcx,[rbp+7]
  ...
  0000000000000027: 48 8B D0           mov         rdx,rax
  000000000000002A: 0F B6 48 18        movzx       ecx,byte ptr [rax+18h]
  000000000000002E: 84 C9              test        cl,cl
  0000000000000030: 0F 85 F3 00 00 00  jne         0000000000000129
  0000000000000036: C7 45 97 02 00 00  mov         dword ptr [rbp-69h],2
                    00
  000000000000003D: E8 00 00 00 00     call        replaced
  ...
  0000000000000042: 48 89 45 9F        mov         qword ptr [rbp-61h],rax
  0000000000000046: 0F 28 45 97        movaps      xmm0,xmmword ptr [rbp-69h]
  000000000000004A: 66 0F 7F 45 97     movdqa      xmmword ptr [rbp-69h],xmm0
  000000000000004F: 48 8D 55 A7        lea         rdx,[rbp-59h]
  0000000000000053: 48 8D 4D 97        lea         rcx,[rbp-69h]
  ...
  000000000000005C: 48 83 78 18 10     cmp         qword ptr [rax+18h],10h
  0000000000000061: 72 03              jb          0000000000000066
  0000000000000063: 48 8B 00           mov         rax,qword ptr [rax]
  0000000000000066: 48 8D 0D 00 00 00  lea         rcx,[??_7exception@std@@6B@]
                    00
  000000000000006D: 48 89 4D C7        mov         qword ptr [rbp-39h],rcx
  0000000000000071: 33 C9              xor         ecx,ecx
  0000000000000073: 48 89 4D CF        mov         qword ptr [rbp-31h],rcx
  0000000000000077: 48 89 4D D7        mov         qword ptr [rbp-29h],rcx
  000000000000007B: 48 89 45 EF        mov         qword ptr [rbp-11h],rax
  000000000000007F: C6 45 F7 01        mov         byte ptr [rbp-9],1
  0000000000000083: 48 8D 55 CF        lea         rdx,[rbp-31h]
  0000000000000087: 48 8D 4D EF        lea         rcx,[rbp-11h]
  000000000000008B: E8 00 00 00 00     call        __std_exception_copy
  0000000000000090: 48 8D 05 00 00 00  lea         rax,[??_7logic_error@std@@6B@]
                    00
  0000000000000097: 48 89 45 C7        mov         qword ptr [rbp-39h],rax
  000000000000009B: 48 8B 45 BF        mov         rax,qword ptr [rbp-41h]
  000000000000009F: 48 83 F8 10        cmp         rax,10h
  00000000000000A3: 72 4C              jb          00000000000000F1
  00000000000000A5: 48 FF C0           inc         rax
  00000000000000A8: 48 8B 4D A7        mov         rcx,qword ptr [rbp-59h]
  00000000000000AC: 48 3D 00 10 00 00  cmp         rax,1000h
  00000000000000B2: 72 38              jb          00000000000000EC
  00000000000000B4: F6 C1 1F           test        cl,1Fh
  00000000000000B7: 74 06              je          00000000000000BF
  00000000000000B9: E8 00 00 00 00     call        _invalid_parameter_noinfo_noreturn
  00000000000000BE: CC                 int         3
  00000000000000BF: 48 8B 41 F8        mov         rax,qword ptr [rcx-8]
  00000000000000C3: 48 3B C1           cmp         rax,rcx
  00000000000000C6: 72 06              jb          00000000000000CE
  00000000000000C8: E8 00 00 00 00     call        _invalid_parameter_noinfo_noreturn
  00000000000000CD: CC                 int         3
  00000000000000CE: 48 2B C8           sub         rcx,rax
  00000000000000D1: 48 83 F9 08        cmp         rcx,8
  00000000000000D5: 73 06              jae         00000000000000DD
  00000000000000D7: E8 00 00 00 00     call        _invalid_parameter_noinfo_noreturn
  00000000000000DC: CC                 int         3
  00000000000000DD: 48 83 F9 27        cmp         rcx,27h
  00000000000000E1: 76 06              jbe         00000000000000E9
  00000000000000E3: E8 00 00 00 00     call        _invalid_parameter_noinfo_noreturn
  00000000000000E8: CC                 int         3
  00000000000000E9: 48 8B C8           mov         rcx,rax
  00000000000000EC: E8 00 00 00 00     call        ??3@YAXPEAX@Z
  00000000000000F1: 48 C7 45 BF 0F 00  mov         qword ptr [rbp-41h],0Fh
                    00 00
  00000000000000F9: 48 C7 45 B7 00 00  mov         qword ptr [rbp-49h],0
                    00 00
  0000000000000101: C6 45 A7 00        mov         byte ptr [rbp-59h],0
  0000000000000105: 48 8D 05 00 00 00  lea         rax,[??_7monad_error@v1_std_std@outcome@boost@@6B@]
                    00
  000000000000010C: 48 89 45 C7        mov         qword ptr [rbp-39h],rax
  0000000000000110: 0F 28 45 97        movaps      xmm0,xmmword ptr [rbp-69h]
  0000000000000114: 0F 11 45 DF        movups      xmmword ptr [rbp-21h],xmm0
  0000000000000118: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@v1_std_std@outcome@boost@@]
                    00
  000000000000011F: 48 8D 4D C7        lea         rcx,[rbp-39h]
  0000000000000123: E8 00 00 00 00     call        _CxxThrowException
  0000000000000128: CC                 int         3
  0000000000000129: 8D 41 FE           lea         eax,[rcx-2]
  000000000000012C: 3C 01              cmp         al,1
  000000000000012E: 77 4A              ja          000000000000017A
  0000000000000130: 80 F9 02           cmp         cl,2
  0000000000000133: 75 25              jne         000000000000015A
  0000000000000135: 0F 10 02           movups      xmm0,xmmword ptr [rdx]
  0000000000000138: 0F 29 45 97        movaps      xmmword ptr [rbp-69h],xmm0
  000000000000013C: 48 8D 55 97        lea         rdx,[rbp-69h]
  0000000000000140: 48 8D 4D 27        lea         rcx,[rbp+27h]
  0000000000000144: E8 00 00 00 00     call        replaced
...
$LN19:
  ...
  0000000000000149: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  0000000000000150: 48 8D 4D 27        lea         rcx,[rbp+27h]
  0000000000000154: E8 00 00 00 00     call        _CxxThrowException
  0000000000000159: CC                 int         3
  000000000000015A: 80 F9 03           cmp         cl,3
  000000000000015D: 75 1B              jne         000000000000017A
  000000000000015F: 48 8D 4D 97        lea         rcx,[rbp-69h]
  0000000000000163: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  0000000000000168: 48 8D 45 97        lea         rax,[rbp-69h]
  000000000000016C: 48 89 45 67        mov         qword ptr [rbp+67h],rax
  0000000000000170: 48 8D 4D 97        lea         rcx,[rbp-69h]
  0000000000000174: E8 00 00 00 00     call        ?__ExceptionPtrRethrow@@YAXPEBX@Z
  0000000000000179: 90                 nop
  000000000000017A: 8B 1A              mov         ebx,dword ptr [rdx]
  000000000000017C: 0F B6 4D 1F        movzx       ecx,byte ptr [rbp+1Fh]
  0000000000000180: 83 E9 01           sub         ecx,1
  0000000000000183: 74 13              je          0000000000000198
  0000000000000185: 83 E9 01           sub         ecx,1
  0000000000000188: 74 0E              je          0000000000000198
  000000000000018A: 83 F9 01           cmp         ecx,1
  000000000000018D: 75 09              jne         0000000000000198
  000000000000018F: 48 8D 4D 07        lea         rcx,[rbp+7]
  0000000000000193: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  0000000000000198: 8B C3              mov         eax,ebx
  000000000000019A: 48 8B 9C 24 F8 00  mov         rbx,qword ptr [rsp+0F8h]
                    00 00
  00000000000001A2: 48 81 C4 E0 00 00  add         rsp,0E0h
                    00
  00000000000001A9: 5D                 pop         rbp
  00000000000001AA: C3                 ret
