 ...
 9cc:	0f b7 44 24 04       	movzwl 0x4(%rsp),%eax
 9d1:	89 c2                	mov    %eax,%edx
 9d3:	83 e2 f7             	and    $0xfffffff7,%edx
 9d6:	66 83 fa 01          	cmp    $0x1,%dx
 9da:	75 08                	jne    9e4 <test1()+0x24>
 9dc:	8b 04 24             	mov    (%rsp),%eax
 9df:	48 83 c4 28          	add    $0x28,%rsp
 9e3:	c3                   	retq
 9e4:	66 83 f8 1e          	cmp    $0x1e,%ax
 ...
 abf:	90                   	nop
 9f6:	ba 44 44 44 44       	mov    $0x44444444,%edx
 9fb:	48 0f a3 c2          	bt     %rax,%rdx
