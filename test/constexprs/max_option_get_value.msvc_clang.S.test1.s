  ...
  000000000000000B: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$option_policy@H@policy@_1_0_std_std_9274c0d4@outcome@boost@@@_1_0_std_std_9274c0d4@outcome@boost@@XZ
  0000000000000010: 80 7C 24 2C 00     cmp         byte ptr [rsp+2Ch],0
  0000000000000015: 74 0B              je          0000000000000022
  0000000000000017: 8B 44 24 28        mov         eax,dword ptr [rsp+28h]
  000000000000001B: 48 83 C4 68        add         rsp,68h
  000000000000001F: 5F                 pop         rdi
  0000000000000020: 5E                 pop         rsi
  0000000000000021: C3                 ret
  0000000000000022: 48 8D 74 24 30     lea         rsi,[rsp+30h]
  0000000000000027: BA 02 00 00 00     mov         edx,2
  000000000000002C: 48 89 F1           mov         rcx,rsi
  0000000000000000: 56                 push        rsi
  0000000000000001: 57                 push        rdi
  ...
  0000000000000034: 48 8D 7C 24 40     lea         rdi,[rsp+40h]
  0000000000000039: 48 89 F9           mov         rcx,rdi
  000000000000003C: 48 89 F2           mov         rdx,rsi
  ...
  0000000000000044: 48 8D 15 00 00 00  lea         rdx,[_TI5?AVmonad_error@_1_0_std_std_9274c0d4@outcome@boost@@]
  000000000000004B: 48 89 F9           mov         rcx,rdi
  000000000000004E: FF 15 00 00 00 00  call        qword ptr [__imp__CxxThrowException]
  0000000000000054: 0F 0B              ud2
  0000000000000056: 66 2E 0F 1F 84 00  nop         word ptr cs:[rax+rax]
