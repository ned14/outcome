  ...
  000000000000001D: 0F B6 50 18        movzx       edx,byte ptr [rax+18h]
  0000000000000021: 84 D2              test        dl,dl
  0000000000000023: 75 0B              jne         0000000000000030
  0000000000000025: B9 02 00 00 00     mov         ecx,2
  ...
  0000000000000030: 80 FA 02           cmp         dl,2
  0000000000000033: 75 05              jne         000000000000003A
  0000000000000035: 0F 10 10           movups      xmm2,xmmword ptr [rax]
  0000000000000038: EB 2B              jmp         0000000000000065
  000000000000003A: 80 FA 03           cmp         dl,3
  000000000000003D: 75 0F              jne         000000000000004E
  0000000000000000: 40 53              push        rbx
  0000000000000002: 48 83 EC 20        sub         rsp,20h
  0000000000000006: 65 48 8B 04 25 58  mov         rax,qword ptr gs:[58h]
  000000000000000F: 8B 0D 00 00 00 00  mov         ecx,dword ptr [_tls_index]
  ...
  0000000000000086: 5B                 pop         rbx
  0000000000000087: C3                 ret
  0000000000000044: C7 44 24 28 03 00  mov         dword ptr [rsp+28h],3
  000000000000004C: EB 0D              jmp         000000000000005B
  000000000000004E: C7 44 24 28 00 00  mov         dword ptr [rsp+28h],0
  0000000000000000: 48 83 EC 28        sub         rsp,28h
  ...
  000000000000005B: 48 89 44 24 30     mov         qword ptr [rsp+30h],rax
  0000000000000060: 0F 10 54 24 28     movups      xmm2,xmmword ptr [rsp+28h]
  0000000000000065: 0F 11 13           movups      xmmword ptr [rbx],xmm2
  0000000000000068: 0F B6 4C 24 58     movzx       ecx,byte ptr [rsp+58h]
  000000000000006D: 83 E9 01           sub         ecx,1
  0000000000000070: 74 14              je          0000000000000086
  0000000000000072: 83 E9 01           sub         ecx,1
  0000000000000075: 74 0F              je          0000000000000086
  0000000000000077: 83 F9 01           cmp         ecx,1
  000000000000007A: 75 0A              jne         0000000000000086
  000000000000007C: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  0000000000000081: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  0000000000000086: 48 8B C3           mov         rax,rbx
  0000000000000089: 48 83 C4 60        add         rsp,60h
