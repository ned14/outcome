  ...
  0000000000000011: 0F B6 51 18        movzx       edx,byte ptr [rcx+18h]
  0000000000000015: 84 D2              test        dl,dl
  0000000000000017: 74 61              je          000000000000007A
  0000000000000019: 8D 42 FE           lea         eax,[rdx-2]
  000000000000001C: 3C 01              cmp         al,1
  000000000000001E: 77 49              ja          0000000000000069
  0000000000000020: 80 FA 02           cmp         dl,2
  0000000000000023: 75 2B              jne         0000000000000050
  0000000000000025: 0F 10 01           movups      xmm0,xmmword ptr [rcx]
  0000000000000028: 48 8D 54 24 30     lea         rdx,[rsp+30h]
  000000000000002D: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  0000000000000032: 0F 29 44 24 30     movaps      xmmword ptr [rsp+30h],xmm0
  ...
  000000000000004A: 48 83 C4 70        add         rsp,70h
  000000000000004E: 5B                 pop         rbx
  000000000000004F: C3                 ret
  0000000000000050: 80 FA 03           cmp         dl,3
  0000000000000053: 75 14              jne         0000000000000069
  0000000000000055: 48 8B D1           mov         rdx,rcx
  0000000000000058: 48 8B CB           mov         rcx,rbx
  000000000000005B: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  0000000000000060: 48 8B C3           mov         rax,rbx
  0000000000000063: 48 83 C4 70        add         rsp,70h
  ...
  0000000000000071: 48 8B C3           mov         rax,rbx
  0000000000000074: 48 83 C4 70        add         rsp,70h
  0000000000000078: 5B                 pop         rbx
  ...
  0000000000000016: E8 00 00 00 00     call        ??0system_error@std@@QEAA@Verror_code@1@@Z
