  ...
  0000000000000002: 48 81 EC C8 00 00  sub         rsp,0C8h
  0000000000000009: 48 8D AC 24 80 00  lea         rbp,[rsp+80h]
  0000000000000011: 48 C7 45 40 FE FF  mov         qword ptr [rbp+40h],0FFFFFFFFFFFFFFFEh
  0000000000000019: 48 89 CE           mov         rsi,rcx
  000000000000001C: 48 8D 4D 18        lea         rcx,[rbp+18h]
  0000000000000020: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$monad_policy@H@policy@_1_0_std_std_9274c0d4@outcome@boost@@@_1_0_std_std_9274c0d4@outcome@boost@@XZ
  0000000000000025: 8A 45 30           mov         al,byte ptr [rbp+30h]
  0000000000000028: 3C 02              cmp         al,2
  000000000000002A: 74 16              je          0000000000000042
  000000000000002C: 3C 03              cmp         al,3
  000000000000002E: 74 60              je          0000000000000090
  0000000000000030: 84 C0              test        al,al
  0000000000000032: 0F 84 8E 00 00 00  je          00000000000000C6
  0000000000000038: 48 89 F1           mov         rcx,rsi
  000000000000003B: E8 00 00 00 00     call        ?__ExceptionPtrCreate@@YAXPEAX@Z
  0000000000000040: EB 5A              jmp         000000000000009C
  0000000000000042: 0F 10 45 18        movups      xmm0,xmmword ptr [rbp+18h]
  0000000000000046: 0F 29 45 F0        movaps      xmmword ptr [rbp-10h],xmm0
  000000000000004A: 48 8D 4D C8        lea         rcx,[rbp-38h]
  000000000000004E: 48 8D 55 F0        lea         rdx,[rbp-10h]
  0000000000000000: 55                 push        rbp
  0000000000000001: 56                 push        rsi
  ...
  0000000000000057: 48 89 F1           mov         rcx,rsi
  000000000000005A: E8 00 00 00 00     call        ?__ExceptionPtrCreate@@YAXPEAX@Z
  000000000000005F: 4C 8D 05 00 00 00  lea         r8,[_TI4?AVsystem_error@std@@]
  0000000000000066: 48 8D 55 C8        lea         rdx,[rbp-38h]
  000000000000006A: 48 89 75 38        mov         qword ptr [rbp+38h],rsi
  000000000000006E: 48 89 F1           mov         rcx,rsi
  0000000000000071: E8 00 00 00 00     call        ?__ExceptionPtrCopyException@@YAXPEAXPEBX1@Z
  0000000000000076: 48 8D 05 00 00 00  lea         rax,[??_7exception@std@@6B@]
  000000000000007D: 48 89 45 C8        mov         qword ptr [rbp-38h],rax
  0000000000000081: 48 8D 4D D0        lea         rcx,[rbp-30h]
  0000000000000085: E8 00 00 00 00     call        __std_exception_destroy
  000000000000008A: 48 8B 75 38        mov         rsi,qword ptr [rbp+38h]
  000000000000008E: EB 0C              jmp         000000000000009C
  0000000000000090: 48 8D 55 18        lea         rdx,[rbp+18h]
  0000000000000094: 48 89 F1           mov         rcx,rsi
  0000000000000097: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  000000000000009C: 8A 45 30           mov         al,byte ptr [rbp+30h]
  000000000000009F: 89 C1              mov         ecx,eax
  00000000000000A1: FE C9              dec         cl
  00000000000000A3: 80 F9 02           cmp         cl,2
  00000000000000A6: 72 0D              jb          00000000000000B5
  00000000000000A8: 3C 03              cmp         al,3
  00000000000000AA: 75 0D              jne         00000000000000B9
  00000000000000AC: 48 8D 4D 18        lea         rcx,[rbp+18h]
  00000000000000B0: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  00000000000000B5: C6 45 30 00        mov         byte ptr [rbp+30h],0
  00000000000000B9: 48 89 F0           mov         rax,rsi
  00000000000000BC: 48 81 C4 C8 00 00  add         rsp,0C8h
  00000000000000C3: 5E                 pop         rsi
  00000000000000C4: 5D                 pop         rbp
  00000000000000C5: C3                 ret
  00000000000000C6: 8B 05 00 00 00 00  mov         eax,dword ptr [?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  00000000000000CC: 8B 0D 00 00 00 00  mov         ecx,dword ptr [_tls_index]
  00000000000000D2: 65 48 8B 14 25 58  mov         rdx,qword ptr gs:[58h]
  00000000000000DB: 48 8B 0C CA        mov         rcx,qword ptr [rdx+rcx*8]
  00000000000000DF: 3B 81 00 00 00 00  cmp         eax,dword ptr _Init_thread_epoch[rcx]
  00000000000000E5: 7E 4B              jle         0000000000000132
  00000000000000E7: 48 8D 0D 00 00 00  lea         rcx,[?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  00000000000000EE: E8 00 00 00 00     call        _Init_thread_header
  00000000000000F3: 8B 05 00 00 00 00  mov         eax,dword ptr [?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  00000000000000F9: 83 F8 FF           cmp         eax,0FFFFFFFFh
  00000000000000FC: 75 34              jne         0000000000000132
  00000000000000FE: 48 8D 05 00 00 00  lea         rax,[?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A]
  0000000000000105: 48 89 05 08 00 00  mov         qword ptr [?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A+8],rax
  000000000000010C: 48 8D 05 00 00 00  lea         rax,[??_7monad_category@_detail@_1_0_std_std_9274c0d4@outcome@boost@@6B@]
  0000000000000113: 48 89 05 00 00 00  mov         qword ptr [?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A],rax
  000000000000011A: 48 8D 0D 00 00 00  lea         rcx,[??__Fc@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@YAXXZ]
  0000000000000121: E8 00 00 00 00     call        atexit
  0000000000000126: 48 8D 0D 00 00 00  lea         rcx,[?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  000000000000012D: E8 00 00 00 00     call        _Init_thread_footer
  0000000000000132: C7 45 08 02 00 00  mov         dword ptr [rbp+8],2
  0000000000000139: 48 8D 05 00 00 00  lea         rax,[?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A]
  0000000000000140: 48 89 45 10        mov         qword ptr [rbp+10h],rax
  0000000000000144: 48 8D 4D A0        lea         rcx,[rbp-60h]
  0000000000000148: 48 8D 55 08        lea         rdx,[rbp+8]
  0000000000000000: 55                 push        rbp
  0000000000000001: 56                 push        rsi
  0000000000000002: 57                 push        rdi
  0000000000000003: 53                 push        rbx
  ...
  00000000000001BA: 0F 0B              ud2
  00000000000001BC: 0F 1F 40 00        nop         dword ptr [rax]
  0000000000000151: 48 8D 05 00 00 00  lea         rax,[??_7monad_error@_1_0_std_std_9274c0d4@outcome@boost@@6B@]
  0000000000000158: 48 89 45 A0        mov         qword ptr [rbp-60h],rax
  000000000000015C: 48 8D 15 00 00 00  lea         rdx,[_TI5?AVmonad_error@_1_0_std_std_9274c0d4@outcome@boost@@]
  0000000000000163: 48 8D 4D A0        lea         rcx,[rbp-60h]
  0000000000000167: FF 15 00 00 00 00  call        qword ptr [__imp__CxxThrowException]
  000000000000016D: 0F 0B              ud2
  000000000000016F: 90                 nop
