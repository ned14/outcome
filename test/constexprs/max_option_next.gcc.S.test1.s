  400f30:	55                   	push   %rbp
  400f31:	53                   	push   %rbx
  400f32:	48 89 fb             	mov    %rdi,%rbx
  400f35:	48 83 ec 38          	sub    $0x38,%rsp
  400f39:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi
  400f3e:	e8 bd f0 bf ff       	callq  0 <_init-0x400c98>
  400f43:	80 7c 24 14 00       	cmpb   $0x0,0x14(%rsp)
  400f48:	74 1e                	je     400f68 <test1()+0x38>
  400f4a:	8b 44 24 10          	mov    0x10(%rsp),%eax
  400f4e:	c6 43 04 01          	movb   $0x1,0x4(%rbx)
  400f52:	8d 04 40             	lea    (%rax,%rax,2),%eax
  400f55:	89 03                	mov    %eax,(%rbx)
  400f57:	48 83 c4 38          	add    $0x38,%rsp
  400f5b:	48 89 d8             	mov    %rbx,%rax
  400f5e:	5b                   	pop    %rbx
  400f5f:	5d                   	pop    %rbp
  400f60:	c3                   	retq
  400f61:	0f 1f 80 00 00 00 00 	nopl   0x0(%rax)
  ...
  400f7e:	74 60                	je     400fe0 <test1()+0xb0>
  ...
  400fb1:	75 65                	jne    401018 <test1()+0xe8>
  400fb3:	c7 43 10 02 00 00 00 	movl   $0x2,0x10(%rbx)
  400fba:	48 c7 43 18 d0 20 60 	movq   $0x6020d0,0x18(%rbx)
  400fc2:	ba d0 10 40 00       	mov    $0x4010d0,%edx
  400fc7:	48 c7 03 90 13 40 00 	movq   $0x401390,(%rbx)
  400fce:	be 18 13 40 00       	mov    $0x401318,%esi
  ...
  400fec:	74 92                	je     400f80 <test1()+0x50>
