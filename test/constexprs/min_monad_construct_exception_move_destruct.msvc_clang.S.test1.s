  ...
  0000000000000004: 48 81 EC E8 00 00  sub         rsp,0E8h
  000000000000000B: 48 8D AC 24 80 00  lea         rbp,[rsp+80h]
  0000000000000013: 48 C7 45 60 FE FF  mov         qword ptr [rbp+60h],0FFFFFFFFFFFFFFFEh
  000000000000001B: 48 89 D7           mov         rdi,rdx
  000000000000001E: 48 89 CB           mov         rbx,rcx
  0000000000000021: 48 8D 75 10        lea         rsi,[rbp+10h]
  0000000000000025: 48 89 F1           mov         rcx,rsi
  0000000000000028: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  000000000000002D: C6 45 28 03        mov         byte ptr [rbp+28h],3
  0000000000000031: C6 45 48 00        mov         byte ptr [rbp+48h],0
  0000000000000035: 48 8D 4D 30        lea         rcx,[rbp+30h]
  0000000000000039: 48 89 F2           mov         rdx,rsi
  000000000000003C: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  0000000000000041: 8A 45 28           mov         al,byte ptr [rbp+28h]
  0000000000000044: 88 45 48           mov         byte ptr [rbp+48h],al
  0000000000000047: 3C 02              cmp         al,2
  0000000000000049: 74 16              je          0000000000000061
  000000000000004B: 3C 03              cmp         al,3
  000000000000004D: 74 68              je          00000000000000B7
  000000000000004F: 84 C0              test        al,al
  0000000000000051: 0F 84 BD 00 00 00  je          0000000000000114
  0000000000000057: 48 89 D9           mov         rcx,rbx
  000000000000005A: E8 00 00 00 00     call        ?__ExceptionPtrCreate@@YAXPEAX@Z
  000000000000005F: EB 62              jmp         00000000000000C3
  0000000000000061: 48 89 7D 58        mov         qword ptr [rbp+58h],rdi
  0000000000000065: 0F 10 45 30        movups      xmm0,xmmword ptr [rbp+30h]
  0000000000000069: 0F 29 45 F0        movaps      xmmword ptr [rbp-10h],xmm0
  000000000000006D: 48 8D 4D C8        lea         rcx,[rbp-38h]
  0000000000000071: 48 8D 55 F0        lea         rdx,[rbp-10h]
  0000000000000000: 55                 push        rbp
  0000000000000001: 56                 push        rsi
  0000000000000002: 57                 push        rdi
  0000000000000003: 53                 push        rbx
  ...
  000000000000002A: 66 48 0F 6E F0     movq        xmm6,rax
  ...
  000000000000007A: 48 89 D9           mov         rcx,rbx
  000000000000007D: E8 00 00 00 00     call        ?__ExceptionPtrCreate@@YAXPEAX@Z
  0000000000000082: 4C 8D 05 00 00 00  lea         r8,[_TI4?AVsystem_error@std@@]
  0000000000000089: 48 8D 55 C8        lea         rdx,[rbp-38h]
  000000000000008D: 48 89 5D 50        mov         qword ptr [rbp+50h],rbx
  0000000000000091: 48 89 D9           mov         rcx,rbx
  0000000000000094: E8 00 00 00 00     call        ?__ExceptionPtrCopyException@@YAXPEAXPEBX1@Z
  0000000000000099: 48 8D 05 00 00 00  lea         rax,[??_7exception@std@@6B@]
  00000000000000A0: 48 89 45 C8        mov         qword ptr [rbp-38h],rax
  00000000000000A4: 48 8D 4D D0        lea         rcx,[rbp-30h]
  00000000000000A8: E8 00 00 00 00     call        __std_exception_destroy
  00000000000000AD: 48 8B 7D 58        mov         rdi,qword ptr [rbp+58h]
  00000000000000B1: 48 8B 5D 50        mov         rbx,qword ptr [rbp+50h]
  00000000000000B5: EB 0C              jmp         00000000000000C3
  00000000000000B7: 48 8D 55 30        lea         rdx,[rbp+30h]
  00000000000000BB: 48 89 D9           mov         rcx,rbx
  00000000000000BE: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  00000000000000C3: 8A 45 48           mov         al,byte ptr [rbp+48h]
  00000000000000C6: 89 C1              mov         ecx,eax
  00000000000000C8: FE C9              dec         cl
  00000000000000CA: 80 F9 02           cmp         cl,2
  00000000000000CD: 72 0D              jb          00000000000000DC
  00000000000000CF: 3C 03              cmp         al,3
  00000000000000D1: 75 0D              jne         00000000000000E0
  00000000000000D3: 48 8D 4D 30        lea         rcx,[rbp+30h]
  00000000000000D7: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  00000000000000DC: C6 45 48 00        mov         byte ptr [rbp+48h],0
  00000000000000E0: 8A 45 28           mov         al,byte ptr [rbp+28h]
  00000000000000E3: 89 C1              mov         ecx,eax
  00000000000000E5: FE C9              dec         cl
  00000000000000E7: 80 F9 02           cmp         cl,2
  00000000000000EA: 72 0D              jb          00000000000000F9
  00000000000000EC: 3C 03              cmp         al,3
  00000000000000EE: 75 0D              jne         00000000000000FD
  00000000000000F0: 48 8D 4D 10        lea         rcx,[rbp+10h]
  00000000000000F4: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  00000000000000F9: C6 45 28 00        mov         byte ptr [rbp+28h],0
  00000000000000FD: 48 89 F9           mov         rcx,rdi
  0000000000000100: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  0000000000000105: 48 89 D8           mov         rax,rbx
  0000000000000108: 48 81 C4 E8 00 00  add         rsp,0E8h
  000000000000010F: 5B                 pop         rbx
  0000000000000110: 5F                 pop         rdi
  0000000000000111: 5E                 pop         rsi
  0000000000000112: 5D                 pop         rbp
  0000000000000113: C3                 ret
  0000000000000114: 48 89 7D 58        mov         qword ptr [rbp+58h],rdi
  0000000000000118: 8B 05 00 00 00 00  mov         eax,dword ptr [?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  000000000000011E: 8B 0D 00 00 00 00  mov         ecx,dword ptr [_tls_index]
  0000000000000124: 65 48 8B 14 25 58  mov         rdx,qword ptr gs:[58h]
  000000000000012D: 48 8B 0C CA        mov         rcx,qword ptr [rdx+rcx*8]
  0000000000000131: 3B 81 00 00 00 00  cmp         eax,dword ptr _Init_thread_epoch[rcx]
  0000000000000137: 7E 4B              jle         0000000000000184
  0000000000000139: 48 8D 0D 00 00 00  lea         rcx,[?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  0000000000000140: E8 00 00 00 00     call        _Init_thread_header
  0000000000000145: 8B 05 00 00 00 00  mov         eax,dword ptr [?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  000000000000014B: 83 F8 FF           cmp         eax,0FFFFFFFFh
  000000000000014E: 75 34              jne         0000000000000184
  0000000000000150: 48 8D 05 00 00 00  lea         rax,[?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A]
  0000000000000157: 48 89 05 08 00 00  mov         qword ptr [?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A+8],rax
  000000000000015E: 48 8D 05 00 00 00  lea         rax,[??_7monad_category@_detail@_1_0_std_std_9274c0d4@outcome@boost@@6B@]
  0000000000000165: 48 89 05 00 00 00  mov         qword ptr [?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A],rax
  000000000000016C: 48 8D 0D 00 00 00  lea         rcx,[??__Fc@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@YAXXZ]
  0000000000000173: E8 00 00 00 00     call        atexit
  0000000000000178: 48 8D 0D 00 00 00  lea         rcx,[?$TSS0@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  000000000000017F: E8 00 00 00 00     call        _Init_thread_footer
  0000000000000184: C7 45 00 02 00 00  mov         dword ptr [rbp],2
  000000000000018B: 48 8D 05 00 00 00  lea         rax,[?c@?1??monad_category@_1_0_std_std_9274c0d4@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A]
  0000000000000192: 48 89 45 08        mov         qword ptr [rbp+8],rax
  0000000000000196: 48 8D 4D A0        lea         rcx,[rbp-60h]
  000000000000019A: 48 89 EA           mov         rdx,rbp
  0000000000000000: 55                 push        rbp
  0000000000000001: 56                 push        rsi
  0000000000000002: 57                 push        rdi
  0000000000000003: 53                 push        rbx
  ...
  00000000000001BA: 0F 0B              ud2
  00000000000001BC: 0F 1F 40 00        nop         dword ptr [rax]
  00000000000001A2: 48 8D 05 00 00 00  lea         rax,[??_7monad_error@_1_0_std_std_9274c0d4@outcome@boost@@6B@]
  00000000000001A9: 48 89 45 A0        mov         qword ptr [rbp-60h],rax
  00000000000001AD: 48 8D 15 00 00 00  lea         rdx,[_TI5?AVmonad_error@_1_0_std_std_9274c0d4@outcome@boost@@]
  00000000000001B4: 48 8D 4D A0        lea         rcx,[rbp-60h]
  00000000000001B8: FF 15 00 00 00 00  call        qword ptr [__imp__CxxThrowException]
  00000000000001BE: 0F 0B              ud2
