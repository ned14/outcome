  ...
  0000000000000029: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$monad_policy@H@policy@_1_0_std_std_9274c0d4@outcome@boost@@@_1_0_std_std_9274c0d4@outcome@boost@@XZ
  ...
  000000000000001E: 0F B6 4A 18        movzx       ecx,byte ptr [rdx+18h]
  0000000000000022: 84 C9              test        cl,cl
  0000000000000024: 75 0B              jne         0000000000000031
  0000000000000026: B9 02 00 00 00     mov         ecx,2
  ...
  0000000000000031: 8D 41 FE           lea         eax,[rcx-2]
  0000000000000034: 3C 01              cmp         al,1
  0000000000000036: 77 46              ja          000000000000007E
  0000000000000038: 80 F9 02           cmp         cl,2
  000000000000003B: 75 29              jne         0000000000000066
  000000000000003D: 0F 10 02           movups      xmm0,xmmword ptr [rdx]
  0000000000000040: 0F 29 44 24 30     movaps      xmmword ptr [rsp+30h],xmm0
  0000000000000045: 48 8D 54 24 30     lea         rdx,[rsp+30h]
  000000000000004A: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  000000000000004F: E8 00 00 00 00     call        ??0system_error@std@@QEAA@Verror_code@1@@Z
  0000000000000054: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
  000000000000005B: 48 8D 4C 24 40     lea         rcx,[rsp+40h]
  0000000000000060: E8 00 00 00 00     call        _CxxThrowException
  0000000000000065: CC                 int         3
  0000000000000066: 80 F9 03           cmp         cl,3
  0000000000000069: 75 13              jne         000000000000007E
  000000000000006B: 48 8D 4C 24 30     lea         rcx,[rsp+30h]
  0000000000000000: 40 53              push        rbx
  0000000000000002: 48 83 EC 20        sub         rsp,20h
  0000000000000006: 48 8B D9           mov         rbx,rcx
  0000000000000009: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  ...
  0000000000000075: 48 8B C8           mov         rcx,rax
  0000000000000000: 48 89 4C 24 08     mov         qword ptr [rsp+8],rcx
  ...
  0000000000000009: CC                 int         3
  0000000000000017: CC                 int         3
  000000000000007D: CC                 int         3
  000000000000007E: 8B 02              mov         eax,dword ptr [rdx]
  0000000000000080: 8D 3C 40           lea         edi,[rax+rax*2]
  0000000000000083: 0F B6 C9           movzx       ecx,cl
  0000000000000086: 83 E9 01           sub         ecx,1
  0000000000000089: 74 18              je          00000000000000A3
  000000000000008B: 83 E9 01           sub         ecx,1
  000000000000008E: 74 13              je          00000000000000A3
  0000000000000090: 83 F9 01           cmp         ecx,1
  0000000000000093: 75 12              jne         00000000000000A7
  0000000000000095: 48 8B CB           mov         rcx,rbx
  0000000000000098: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  000000000000009D: C6 43 18 00        mov         byte ptr [rbx+18h],0
  00000000000000A1: EB 04              jmp         00000000000000A7
  00000000000000A3: C6 42 18 00        mov         byte ptr [rdx+18h],0
  00000000000000A7: 8B C7              mov         eax,edi
  00000000000000A9: 48 8B 9C 24 80 00  mov         rbx,qword ptr [rsp+80h]
  00000000000000B1: 48 83 C4 70        add         rsp,70h
