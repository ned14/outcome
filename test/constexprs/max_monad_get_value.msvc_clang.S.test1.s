  ...
  0000000000000011: 48 C7 45 40 FE FF  mov         qword ptr [rbp+40h],0FFFFFFFFFFFFFFFEh
                    FF FF
  0000000000000019: 48 8D 4D 20        lea         rcx,[rbp+20h]
  000000000000001D: E8 00 00 00 00     call        ?unknown@@YA?AV?$basic_monad@U?$monad_policy@H@detail@v1_std_std@outcome@boost@@@v1_std_std@outcome@boost@@XZ
  0000000000000022: 0F B6 45 38        movzx       eax,byte ptr [rbp+38h]
  0000000000000026: 83 F8 03           cmp         eax,3
  0000000000000029: 74 35              je          0000000000000060
  000000000000002B: 3C 02              cmp         al,2
  000000000000002D: 74 4B              je          000000000000007A
  000000000000002F: 84 C0              test        al,al
  0000000000000031: 74 6E              je          00000000000000A1
  0000000000000033: 8B 75 20           mov         esi,dword ptr [rbp+20h]
  0000000000000036: 83 F8 03           cmp         eax,3
  0000000000000039: 74 0C              je          0000000000000047
  000000000000003B: 83 F8 02           cmp         eax,2
  000000000000003E: 74 10              je          0000000000000050
  0000000000000040: 83 F8 01           cmp         eax,1
  0000000000000043: 74 0B              je          0000000000000050
  0000000000000045: EB 0D              jmp         0000000000000054
  0000000000000047: 48 8D 4D 20        lea         rcx,[rbp+20h]
  000000000000004B: E8 00 00 00 00     call        ?__ExceptionPtrDestroy@@YAXPEAX@Z
  0000000000000050: C6 45 38 00        mov         byte ptr [rbp+38h],0
  0000000000000054: 89 F0              mov         eax,esi
  0000000000000056: 48 81 C4 C8 00 00  add         rsp,0C8h
                    00
  000000000000005D: 5E                 pop         rsi
  000000000000005E: 5D                 pop         rbp
  000000000000005F: C3                 ret
  0000000000000060: 48 8D 75 F0        lea         rsi,[rbp-10h]
  0000000000000064: 48 8D 55 20        lea         rdx,[rbp+20h]
  0000000000000068: 48 89 F1           mov         rcx,rsi
  000000000000006B: E8 00 00 00 00     call        ?__ExceptionPtrCopy@@YAXPEAXPEBX@Z
  0000000000000070: 48 89 F1           mov         rcx,rsi
  ...
  0000000000000078: 0F 0B              ud2
  000000000000007A: 0F 10 45 20        movups      xmm0,xmmword ptr [rbp+20h]
  000000000000007E: 0F 29 45 00        movaps      xmmword ptr [rbp],xmm0
  0000000000000082: 48 8D 4D C8        lea         rcx,[rbp-38h]
  0000000000000086: 48 8D 55 00        lea         rdx,[rbp]
  000000000000008A: E8 00 00 00 00     call        replaced
  0000000000000000: 55                 push        rbp
  0000000000000001: 56                 push        rsi
  ...
  000000000000008F: 48 8D 15 00 00 00  lea         rdx,[_TI4?AVsystem_error@std@@]
                    00
  0000000000000096: 48 8D 4D C8        lea         rcx,[rbp-38h]
  000000000000009A: E8 00 00 00 00     call        _CxxThrowException
  000000000000009F: 0F 0B              ud2
  00000000000000A1: C7 45 10 00 00 00  mov         dword ptr [rbp+10h],0
                    00
  00000000000000A8: 48 C7 45 18 00 00  mov         qword ptr [rbp+18h],0
                    00 00
  00000000000000B0: 8B 05 00 00 00 00  mov         eax,dword ptr [?$TSS0@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  00000000000000B6: 8B 0D 00 00 00 00  mov         ecx,dword ptr [_tls_index]
  00000000000000BC: 65 48 8B 14 25 58  mov         rdx,qword ptr gs:[58h]
                    00 00 00
  00000000000000C5: 48 8B 0C CA        mov         rcx,qword ptr [rdx+rcx*8]
  00000000000000C9: 3B 81 00 00 00 00  cmp         eax,dword ptr _Init_thread_epoch[rcx]
  00000000000000CF: 7E 4B              jle         000000000000011C
  00000000000000D1: 48 8D 0D 00 00 00  lea         rcx,[?$TSS0@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
                    00
  00000000000000D8: E8 00 00 00 00     call        _Init_thread_header
  00000000000000DD: 8B 05 00 00 00 00  mov         eax,dword ptr [?$TSS0@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
  00000000000000E3: 83 F8 FF           cmp         eax,0FFFFFFFFh
  00000000000000E6: 75 34              jne         000000000000011C
  00000000000000E8: 48 8D 05 00 00 00  lea         rax,[?c@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A]
                    00
  00000000000000EF: 48 89 05 08 00 00  mov         qword ptr [?c@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A+8],rax
                    00
  00000000000000F6: 48 8D 05 00 00 00  lea         rax,[??_7monad_category@_detail@v1_std_std@outcome@boost@@6B@]
                    00
  00000000000000FD: 48 89 05 00 00 00  mov         qword ptr [?c@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A],rax
                    00
  0000000000000104: 48 8D 0D 00 00 00  lea         rcx,[??__Fc@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV1_detail@234@XZ@YAXXZ]
                    00
  000000000000010B: E8 00 00 00 00     call        atexit
  0000000000000110: 48 8D 0D 00 00 00  lea         rcx,[?$TSS0@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV0_detail@123@XZ@4HA]
                    00
  0000000000000117: E8 00 00 00 00     call        _Init_thread_footer
  000000000000011C: C7 45 10 02 00 00  mov         dword ptr [rbp+10h],2
                    00
  0000000000000123: 48 8D 05 00 00 00  lea         rax,[?c@?1??monad_category@v1_std_std@outcome@boost@@YAAEBV1_detail@234@XZ@4V15234@A]
                    00
  000000000000012A: 48 89 45 18        mov         qword ptr [rbp+18h],rax
  000000000000012E: 48 8D 4D A0        lea         rcx,[rbp-60h]
  0000000000000132: 48 8D 55 10        lea         rdx,[rbp+10h]
  0000000000000136: E8 00 00 00 00     call        replaced
  0000000000000000: 55                 push        rbp
  0000000000000001: 56                 push        rsi
  0000000000000002: 57                 push        rdi
  0000000000000003: 53                 push        rbx
  ...
  000000000000013B: 48 8D 15 00 00 00  lea         rdx,[_TI3?AVmonad_error@v1_std_std@outcome@boost@@]
                    00
  0000000000000142: 48 8D 4D A0        lea         rcx,[rbp-60h]
  0000000000000146: E8 00 00 00 00     call        _CxxThrowException
  000000000000014B: 0F 0B              ud2
  000000000000014D: 0F 1F 00           nop         dword ptr [rax]
