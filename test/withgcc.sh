...
time $CXX -std=c++14 -pthread -O1 -DNDEBUG -DBOOST_SPINLOCK_MONAD_ENABLE_OPERATORS=1 -g -gdwarf-2 -o unittests_valgrind unittests.cpp -lrt -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-elide-constructors -fno-inline -DBOOST_SPINLOCK_ENABLE_VALGRIND $INCLUDE
echo Building unittests_1 ...
time $CXX -Wall -Wextra -std=c++14 -pthread -O3 -DNDEBUG -g -gdwarf-2 -o unittests_1 unittests.cpp -lrt $INCLUDE -Wno-unknown-pragmas -Wno-unused-function
echo Building unittests_N ...
time $CXX -Wall -Wextra -std=c++14 -pthread -O3 -DNDEBUG -g -fopenmp -gdwarf-2 -o unittests_N unittests.cpp -lrt $INCLUDE -Wno-unused-function
if [ -n "$BUILD_EXTRA" ]; then
